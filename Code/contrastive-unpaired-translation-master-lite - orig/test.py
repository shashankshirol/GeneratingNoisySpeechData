...
def save_audio(opt, visuals, img_path):
    ...
    for label, im_data in visuals.items():
        ...
        im = denorm_and_numpy(im_data)
        data, sr = getTimeSeries(im, img_path, opt.spec_power, opt.energy)
...
if __name__ == '__main__':
    ...
    opt.preprocess = "resize" #No need to pass domainA through codec again
    ...
    for i, data in enumerate(dataset):
        ...
        save_audio(opt, visuals, img_path)
