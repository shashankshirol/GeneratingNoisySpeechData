...
def save_spec_img(filename, mag_spec, phase, sr, clean = 0):
    ...
    print(mag_spec)
    mag_spec = librosa.power_to_db(mag_spec**2)
...
def reconstruct_from_image(filename):
    name = filename.split('.')[0]
...
def main():
    ...
    #reconstruct_from_image("female.png")

    normLSD("female.wav", "female_recon.wav")
    return
